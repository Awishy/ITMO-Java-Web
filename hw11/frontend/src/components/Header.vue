<template>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="#" @click.prevent="changePage('Index', true)">Home</a></li>
                <li><a href="#" @click.prevent="changePage('Users', true)">Users</a></li>
...
export default {
    ...
    props: ["user"],
    methods: {
        changePage: function (page, updateData) {
            this.$root.$emit("onChangePage", page, {}, updateData);
        },
        onLogout: function () {
