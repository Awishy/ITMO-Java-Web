...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new ServletException("Method should contain only HttpServletRequest.class " +
                    "and Map.class arguments [pageClass="
                    + pageClass + ", method=" + method + "]");
        }

        HttpSession session = request.getSession();
        String lang = request.getParameter("lang");
        String languageTemplatePath = "";
        ...
        if (lang != null) {
            languageTemplatePath = pageClass.getSimpleName() + "_" + lang + ".ftlh";
        }
        ...
        Template template;
        try {
            template = newTemplate(languageTemplatePath);
