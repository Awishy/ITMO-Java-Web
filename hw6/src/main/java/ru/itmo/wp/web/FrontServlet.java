...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method beforeMethod = getMethod(pageClass, "before");
        Method afterMethod = getMethod(pageClass, "after");
        ...
        invokeMethod(request, response, pageClass, beforeMethod, page, view);
        boolean redirected = invokeMethod(request, response, pageClass, method, page, view);
        invokeMethod(request, response, pageClass, afterMethod, page, view);
        if (redirected) {
            return;
        }
    ...
    private boolean invokeMethod(HttpServletRequest request, HttpServletResponse response, Class<?> pageClass,
                                 Method method, Object page, Map<String, Object> view) throws ServletException, IOException {
        try {
    ...
    private Method getMethod(Class<?> pageClass, String methodName) throws NotFoundException {
        Method method = null;
